...
const Layout = ({ children, title, active }) => {
  ...
  // Respaldo en caso de que el usuario no esté completamente cargado pero la ruta protegida lo permitió
  const currentUser = user || { role: 'vendedor', nombre: 'Guest', apellido: '' };
      ...
      <nav className="topnav" id="topnav">
        <div className="nav-top-row">
          ...
          <div className="nav-user">
            ...
            <span className="nav-username">{currentUser.nombre} {currentUser.apellido}</span>
